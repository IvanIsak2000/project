...
while True:
    ...
    print("№",n,"\n","Было:  ", was," рублей ",now_time," ",day)#СЧИТЫВАЕМ КУРС ПРОШЛОГО ВРЕМЕНИ М СОХРАНЯЕМ ЕГО В ПЕРЕМЕННУЮ was
    n +=1
    time.sleep(t)#ВРЕМЯ ОЖИДАНИЯ 
    ...
    print(" Стало: ",NOW," рублей ",now_time_1," ",day_1,"       Разница: ",NOW-was)
    print("-------------------------------------------------------------------------------------------")
    r = NOW-was
    with open ("do_aftet.txt","a") as f:
        st=" "
        text= ("№",n,"\n","Было:  ", was," рублей ",now_time," ",day,"\n","Стало: ",NOW," рублей ",now_time_1," ",day_1,"    Разница: ",r,"\n","-------------------------------------------------------------------------------------------","\n")
        for string in text:
            st += str(string)
        f.write(st)
